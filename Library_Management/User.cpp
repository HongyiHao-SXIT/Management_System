...
User::User(const string& id, const string& name, int age, int deposit, const string& address, Gender gender, const string& phone_number, const string& account, const string& password)
    : id(id), name(name), age(age), deposit(deposit), address(address), gender(gender), phone_number(phone_number), account(account), password(password) {}
